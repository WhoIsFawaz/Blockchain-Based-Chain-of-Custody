            ...
            <div class='panel col-md-8' style='width: 400px; height:230px;'>
              ...
              <div class='col-md-8'>
                <div class='card-body'>
                  ...
                  <hr>
                  <button pid='$pro_keywords' tid='$pro_title' uid='$pro_port' style='float:left;' class='btn btn-primary btn-xs' id='checkout1' onclick='Alert()'>Check Out</button>
                </div>
              </div>
            </div>
...
function Alert(){
	swal("Dear User,", "Check Out Successful!", "success");
}
</script>
