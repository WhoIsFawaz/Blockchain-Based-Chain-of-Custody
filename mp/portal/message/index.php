      ...
      <div class="sidebar">
        <div class="user-profile">
          ...
          <div class="info-wrapper">
            ...
            <br>
            <span class="display-income">Announcements</span>
          </div>
        </div>
      ...
      <div class="page-content-wrapper">
        <div class="page-content-wrapper-inner">
          <div class="content-viewport">
            ...
            <?php
              $sql = "SELECT id, username, datetime, title, message FROM news";
              ...
              echo "<br>";
              echo "<p><i>By: ". $row["username"]. "</i></p>";
              echo "<p><i>" . $row["datetime"]. " </i></p>";
              echo "<br>";
              echo "<hr>";
